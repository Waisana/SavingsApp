    ...
    <div class="mt-4 mb-4 p-3 bg-white border shadow-sm lh-sm">
        <div class="container">
          <div class="romodule-head border-bottom mb-4">
            <h6 class="mb-4 bc-header font-weight-bold">All clients Detail</h6>
          </div>
              ...
              <tbody>
                @if (count($clients) > 0)
                  ...
                  <tr>
                    ...
                    <td><a href ="/savings/edit/{{ $client->id }}" type="button"  class="update btn btn-success btn-sm"><i class="fas fa-dollar-sign"></i></a></td>
